...
class OursTrainer(object):
    def __init__(self,
        ...
        self.graph_bias=get_graph_supports()
    ...
    def _run(self, inputs,):
        ...
        outputs = self.model(inputs.to(self.device),self.graph_bias[0].to(self.device),self.graph_bias[1].to(self.device),self.graph_bias[2].to(self.device),self.graph_bias[3].to(self.device))
...
def get_graph_supports():
    ...
    return in_degree,out_degree,shortest_path_result,shortest_hop_result
