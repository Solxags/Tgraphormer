...
def train(_config, resume: bool = False, test: bool = False):
    ...
    device = torch.device(0)#使用第一个GPU
    ...
    model = make_model(**_config['model']['TGraphormer'])
...
if __name__ == '__main__':
    ...
    config_default='metr-la-config'
    name_default='TGraphormer'
    ...
    parser.add_argument('--name',  type=str,default=name_default,help='The name of the folder where the model is stored.')
